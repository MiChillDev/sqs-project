...
function JokePage() {
	...
	const isEmpty =
		jokeQuery.isSuccess && jokeQuery.data && !jokeQuery.data.content;
	...
	const handleFetch = async () => {
		...
		const isEmpty = result.status === "success" && joke && !joke.content;
	      ...
	      `}
				...
				<CardContent className="h-full flex flex-col items-center justify-center gap-6 text-center overflow-hidden">
					...
					{!hasFetched && !jokeQuery.isError && (
						<div className="text-2xl font-heading text-[#2C3E50]">
