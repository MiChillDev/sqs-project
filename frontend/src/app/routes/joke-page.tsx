  ...
  return (
    <div className='flex-1 flex flex-col items-center justify-center gap-12 bg-linear-to-br from-playful-bg-start via-playful-bg-mid to-playful-bg-end font-body relative overflow-hidden'>
      <h1
        ...
        className='text-[4rem] font-heading text-playful-heading drop-shadow-[3px_3px_0px_var(--color-playful-accent)] dark:drop-shadow-[0_0_15px_var(--color-playful-accent)] -rotate-2 tracking-wide'
      >
        {t('jokePage.heading')}
      </h1>
